...
import com.bbcc.mobilehealth.ActionHistoryActivity;
...
public class HomeFragment extends Fragment implements OnClickListener {
	...
	private static class ImageHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case MSG_UPDATE_IMAGE:
				...
				// 准备下次播放
				homeFragment.handler.sendEmptyMessageDelayed(MSG_UPDATE_IMAGE,
						MSG_DELAY);
				break;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		viewPager = (ViewPager) getActivity().findViewById(
				R.id.homepage_viewpager);
		LayoutInflater inflater = LayoutInflater.from(getActivity());
		ImageView view1 = (ImageView) inflater.inflate(
				R.layout.viewpage_imageview, null);
		ImageView view2 = (ImageView) inflater.inflate(
				R.layout.viewpage_imageview, null);
		ImageView view3 = (ImageView) inflater.inflate(
				R.layout.viewpage_imageview, null);
	...
	public void onClick(View view) {
		...
		case R.id.homepage_item3:
			intent = new Intent(getActivity(), ActionHistoryActivity.class);
			startActivity(intent);
			break;
		case R.id.homepage_item4:
			intent = new Intent(getActivity(), ExceptionRecordActivity.class);
			startActivity(intent);
			break;
	...
	public void onResume() {
		super.onResume();
		Constant.PHONE_NUMBER = "12345671111";
